...
public interface ICustomerRepository extends JpaRepository<Customers,Long> {
    @Query(value = "select * from customers where name_customer like :nameSearch and email_customer like :emailSearch and id_type_customer like :customerType and is_delete = 0",nativeQuery = true)
